...
alias inCampus='sudo cp /etc/apt/temp.text /etc/apt/apt.conf'
alias offCampus='sudo cp /etc/apt/noProxy.text /etc/apt/apt.conf'
...
alias sss='/home/vishal/Sublime\ Text\ 2/sublime_text &'
...
alias exp='export http_proxy=http://2014vvchillal:Airforce\&777@196.1.114.35:2222; export ftp_proxy=ftp://2014vvchillal:Airforce\&777@196.1.114.35:2222; export https_proxy=https://2014vvchillal:Airforce\&777@196.1.114.35:2222'